...
class SubscriberMethodFinder {
    ...
    static Class<?> loadClass(ClassLoader loader, Class<?> subscriberClass) {
        try {
            return loader.loadClass(subscriberClass.getName());
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    List<SubscriberMethod> findSubscriberMethods(ClassLoader loader, String stuckClassName, Class<?> subscriberClass, String eventMethodName) {
